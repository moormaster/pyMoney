...
class TestTreeNode(unittest.TestCase):
    ...
    def test___iter__(self):
        ...
        expected_set = set([
                   self.tree,
                   self.childnode1,
                   self.subchildnode1_1,
                   self.subchildnode1_2,
                   self.childnode2,
                   self.subchildnode2_1,
                   self.subchildnode2_2])
    ...
    def test_find_nodes_by_relative_path(self):
        ...
        self.assertSetEqual(set(nodelist), set([self.subchildnode1_1, self.subchildnode2_1]))
