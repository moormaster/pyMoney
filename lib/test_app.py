...
class TestCategoryNameFormatter(unittest.TestCase):
	...
	def test_format_name(self):
		self.categorynameformatter.set_strategy(app.CategoryNameFormatter.STRATEGY_NAME)
	...
	def test_format_fullname(self):
		self.categorynameformatter.set_strategy(app.CategoryNameFormatter.STRATEGY_FULL_NAME)
