	...
	case ${COMP_WORDS[$_ARGINDEX]} in
		...
		list)
			case ${COMP_WORDS[$(( $COMP_CWORD - 1 ))]} in
				...
				*)
					COMPREPLY=( $( compgen -W "--category --fromcategory --tocategory --from --nopaymentplans --paymentplansonly --paymentplan --paymentplangroup" "\\${COMP_WORDS[$COMP_CWORD]}" ) )
					;;
			esac
			;;
	...
	case ${COMP_WORDS[2]} in
		categories)
			case ${COMP_WORDS[$(( $COMP_CWORD - 1 ))]} in
				...
				*)
					COMPREPLY=( $( compgen -W "--category --cashflowcategory --from --nopaymentplans --paymentplansonly --paymentplan --paymentplangroup --showempty --maxlevel" "\\${COMP_WORDS[$COMP_CWORD]}" ) )
					;;
			esac
			;;
...
_pymoney_export()
{
	...
	case ${COMP_WORDS[$(( $COMP_CWORD - 1 ))]} in
		...
		*)
			COMPREPLY=( $( compgen -W "--category --fromcategory --tocategory --from" "\\${COMP_WORDS[$COMP_CWORD]}" ) )
			;;
	esac
}
